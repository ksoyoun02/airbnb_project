...
<style type="text/css">
@font-face {
	src : url("resources/fonts/BMHANNAPro.ttf");
	font-family: "HANNA"
}
...
<body>
	...
	<form action="/airbnb/room/roomList" class="search" style="position:absolute; top: 840px; width: 1070px; left: 450px; background:rgba(255,255,255,0.5);"  method="post">
		...
		<div style="float: left; padding-right : 20px;">
			...
			<button type="submit" style="margin-top: 30px; margin-bottom: 30px; border:none; border-radius:20px; width: 100px; height: 35px;" id="date" onclick="date_check();">검색</button>
	</form>
</body>
</html>