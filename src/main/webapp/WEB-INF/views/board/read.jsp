...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading" style="font-family: 'NANUM'">첨부파일</div>
      <!-- /.panel-heading -->
      <div class="panel-body">
  ...
  <div class="col-lg-12">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <i class="fa fa-comments fa-fw"></i><span style="font-family: 'NANUM';font-size: 20px;font-weight: bold;">댓글</span> 
        <c:if test="${not empty loginUser}">
	        <button id='addReplyBtn' class='btn btn-primary btn-xs pull-right'><span style="font-family: 'NANUM'">댓글작성</span> </button>
        </c:if>
      </div>      
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel" style="font-family: 'NANUM'">댓글작성</h4>
            </div>
			...
			<c:if test="${loginUser.id ==  board.writer}">
        		<button id="modalModifyBtn" type="button" class="btn btn-warning">수정하기</button>
        		<button id="modalRemoveBtn" type="button" class="btn btn-danger">지우기</button>
        	</c:if>
        		<button id="modalRegisterBtn" type="button" class="btn btn-primary">댓글작성</button>
        		<button id="modalCloseBtn" type="button" class="btn btn-default">나가기</button>
      		</div>          
    	</div>
          <!-- /.modal-content -->
	</div>
